...
namespace Kartverket.FinnPosisjon.Tests.Services
{
    public class CoordinateTransformerTests
    {
        ...
        public void TransformTest()
        {
            ...
            transformedCoordinates = CoordinateTransformer.Transform(originalCoordinates.X, originalCoordinates.Y, 22);
            ...
            transformedCoordinates = CoordinateTransformer.Transform(originalCoordinates.X, originalCoordinates.Y, 23);
            ...
            transformedCoordinates = CoordinateTransformer.Transform(originalCoordinates.X, originalCoordinates.Y, 25);
            ...
            transformedCoordinates = CoordinateTransformer.Transform(originalCoordinates.X, originalCoordinates.Y, 1);
            ...
            transformedCoordinates = CoordinateTransformer.Transform(originalCoordinates.X, originalCoordinates.Y, 2);
            ...
            transformedCoordinates = CoordinateTransformer.Transform(originalCoordinates.X, originalCoordinates.Y, 3);
            ...
            transformedCoordinates = CoordinateTransformer.Transform(originalCoordinates.X, originalCoordinates.Y, 4);
            ...
            transformedCoordinates = CoordinateTransformer.Transform(originalCoordinates.X, originalCoordinates.Y, 5);
            ...
            transformedCoordinates = CoordinateTransformer.Transform(originalCoordinates.X, originalCoordinates.Y, 6);
            ...
            transformedCoordinates = CoordinateTransformer.Transform(originalCoordinates.X, originalCoordinates.Y, 7);
            ...
            transformedCoordinates = CoordinateTransformer.Transform(originalCoordinates.X, originalCoordinates.Y, 8);
            ...
            transformedCoordinates = CoordinateTransformer.Transform(originalCoordinates.X, originalCoordinates.Y, 84);
            ...
            transformedCoordinates = CoordinateTransformer.Transform(originalCoordinates.X, originalCoordinates.Y, 101);
