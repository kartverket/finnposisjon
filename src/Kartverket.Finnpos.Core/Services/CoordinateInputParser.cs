...
public class CoordinateInputParser
{
    ...
    public static List<Coordinates>
        MakeCoordinates(Coordinates coordinates,
            bool comprehensive) // TODO: Move to List<Coordinates>CoordinateTweaker().Swap(Coordinates naturalCoordinates).Invert(noko)
    {
